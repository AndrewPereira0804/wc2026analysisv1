...
![alt text](outputs/charts/matches_by_bias.png)
...
![alt text](outputs/charts/match_score_vs_spread.png)
...
# Team Summaries
![alt text](outputs/charts/total_benefit.png)
![alt text](outputs/charts/total_harm.png)
...
![alt text](outputs/charts/impact_per_match.png)
...
![alt text](outputs/charts/impact_by_stage.png)
...
![alt text](outputs/charts/incident_count_vs_impact.png)
...
![alt text](outputs/charts/impact_by_incident_type.png)
...
![alt text](outputs/charts/ultimate_do_bigger_teams_get_the_whistle.png)
![alt text](outputs/charts/ultimate_whistle_evidence_map.png)
